...
func NewListTranscriptionResponse() *ListTranscriptionResponse {
	this := ListTranscriptionResponse{}
	return &this
}
...
func (o *ListTranscriptionResponse) GetTranscriptions() []ApiV2010AccountTranscription {
	if o == nil || o.Transcriptions == nil {
		var ret []ApiV2010AccountTranscription
		return ret
	}
...
// SetTranscriptions gets a reference to the given []ApiV2010AccountTranscription and assigns it to the Transcriptions field.
...
func (o ListTranscriptionResponse) MarshalJSON() ([]byte, error) {
...
type NullableListTranscriptionResponse struct {
	value *ListTranscriptionResponse
	isSet bool
}

func (v NullableListTranscriptionResponse) Get() *ListTranscriptionResponse {
	return v.value
}

func (v *NullableListTranscriptionResponse) Set(val *ListTranscriptionResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListTranscriptionResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListTranscriptionResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTranscriptionResponse(val *ListTranscriptionResponse) *NullableListTranscriptionResponse {
	return &NullableListTranscriptionResponse{value: val, isSet: true}
}

func (v NullableListTranscriptionResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTranscriptionResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
