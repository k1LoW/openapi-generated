...
// SetAccounts gets a reference to the given []ApiV2010Account and assigns it to the Accounts field.
...
type NullableListAccountResponse struct {
	value *ListAccountResponse
	isSet bool
}

func (v NullableListAccountResponse) Get() *ListAccountResponse {
	return v.value
}

func (v *NullableListAccountResponse) Set(val *ListAccountResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListAccountResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListAccountResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListAccountResponse(val *ListAccountResponse) *NullableListAccountResponse {
	return &NullableListAccountResponse{value: val, isSet: true}
}

func (v NullableListAccountResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListAccountResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
