...
type ApiV2010AccountConference struct {
	...
	CallSidEndingConference NullableString `json:"call_sid_ending_conference,omitempty"`
	...
	ReasonConferenceEnded NullableString `json:"reason_conference_ended,omitempty"`
...
func NewApiV2010AccountConference() *ApiV2010AccountConference {
	this := ApiV2010AccountConference{}
	return &this
}
...
func (o *ApiV2010AccountConference) SetAccountSidNil() {
...
func (o *ApiV2010AccountConference) SetApiVersionNil() {
...
// GetCallSidEndingConference returns the CallSidEndingConference field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ApiV2010AccountConference) GetCallSidEndingConference() string {
	if o == nil || o.CallSidEndingConference.Get() == nil {
		var ret string
		return ret
	}
	return *o.CallSidEndingConference.Get()
}
...
func (o *ApiV2010AccountConference) GetCallSidEndingConferenceOk() (*string, bool) {
	...
	return o.CallSidEndingConference.Get(), o.CallSidEndingConference.IsSet()
}
...
func (o *ApiV2010AccountConference) HasCallSidEndingConference() bool {
	if o != nil && o.CallSidEndingConference.IsSet() {
		return true
	}
...
// SetCallSidEndingConference gets a reference to the given NullableString and assigns it to the CallSidEndingConference field.
func (o *ApiV2010AccountConference) SetCallSidEndingConference(v string) {
	o.CallSidEndingConference.Set(&v)
}
// SetCallSidEndingConferenceNil sets the value for CallSidEndingConference to be an explicit nil
func (o *ApiV2010AccountConference) SetCallSidEndingConferenceNil() {
	o.CallSidEndingConference.Set(nil)
}
...
func (o *ApiV2010AccountConference) UnsetCallSidEndingConference() {
	o.CallSidEndingConference.Unset()
}
...
func (o *ApiV2010AccountConference) SetDateCreatedNil() {
...
func (o *ApiV2010AccountConference) SetDateUpdatedNil() {
...
func (o *ApiV2010AccountConference) SetFriendlyNameNil() {
...
// GetReasonConferenceEnded returns the ReasonConferenceEnded field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ApiV2010AccountConference) GetReasonConferenceEnded() string {
	if o == nil || o.ReasonConferenceEnded.Get() == nil {
		var ret string
		return ret
	}
	return *o.ReasonConferenceEnded.Get()
}
...
func (o *ApiV2010AccountConference) GetReasonConferenceEndedOk() (*string, bool) {
	...
	return o.ReasonConferenceEnded.Get(), o.ReasonConferenceEnded.IsSet()
}
...
func (o *ApiV2010AccountConference) HasReasonConferenceEnded() bool {
	if o != nil && o.ReasonConferenceEnded.IsSet() {
		return true
	}
...
// SetReasonConferenceEnded gets a reference to the given NullableString and assigns it to the ReasonConferenceEnded field.
func (o *ApiV2010AccountConference) SetReasonConferenceEnded(v string) {
	o.ReasonConferenceEnded.Set(&v)
}
// SetReasonConferenceEndedNil sets the value for ReasonConferenceEnded to be an explicit nil
func (o *ApiV2010AccountConference) SetReasonConferenceEndedNil() {
	o.ReasonConferenceEnded.Set(nil)
}
...
func (o *ApiV2010AccountConference) SetRegionNil() {
	o.Region.Set(nil)
}
...
func (o *ApiV2010AccountConference) SetSidNil() {
	o.Sid.Set(nil)
}
...
func (o *ApiV2010AccountConference) SetStatusNil() {
	o.Status.Set(nil)
}
...
func (o *ApiV2010AccountConference) SetUriNil() {
	o.Uri.Set(nil)
}
...
func (o ApiV2010AccountConference) MarshalJSON() ([]byte, error) {
	...
	if o.CallSidEndingConference.IsSet() {
		toSerialize["call_sid_ending_conference"] = o.CallSidEndingConference.Get()
	}
	...
	if o.ReasonConferenceEnded.IsSet() {
		toSerialize["reason_conference_ended"] = o.ReasonConferenceEnded.Get()
	}
	if o.Region.IsSet() {
...
type NullableApiV2010AccountConference struct {
	value *ApiV2010AccountConference
	isSet bool
}

func (v NullableApiV2010AccountConference) Get() *ApiV2010AccountConference {
	return v.value
}

func (v *NullableApiV2010AccountConference) Set(val *ApiV2010AccountConference) {
	v.value = val
	v.isSet = true
}

func (v NullableApiV2010AccountConference) IsSet() bool {
	return v.isSet
}

func (v *NullableApiV2010AccountConference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiV2010AccountConference(val *ApiV2010AccountConference) *NullableApiV2010AccountConference {
	return &NullableApiV2010AccountConference{value: val, isSet: true}
}

func (v NullableApiV2010AccountConference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiV2010AccountConference) UnmarshalJSON(src []byte) error {
	v.isSet = true
