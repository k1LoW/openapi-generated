...
func NewListUsageRecordYesterdayResponse() *ListUsageRecordYesterdayResponse {
	this := ListUsageRecordYesterdayResponse{}
	return &this
}
...
func (o *ListUsageRecordYesterdayResponse) GetUsageRecords() []ApiV2010AccountUsageUsageRecordUsageRecordYesterday {
	if o == nil || o.UsageRecords == nil {
		var ret []ApiV2010AccountUsageUsageRecordUsageRecordYesterday
		return ret
	}
...
// SetUsageRecords gets a reference to the given []ApiV2010AccountUsageUsageRecordUsageRecordYesterday and assigns it to the UsageRecords field.
func (o *ListUsageRecordYesterdayResponse) SetUsageRecords(v []ApiV2010AccountUsageUsageRecordUsageRecordYesterday) {
	o.UsageRecords = v
}

func (o ListUsageRecordYesterdayResponse) MarshalJSON() ([]byte, error) {
...
type NullableListUsageRecordYesterdayResponse struct {
	value *ListUsageRecordYesterdayResponse
	isSet bool
}

func (v NullableListUsageRecordYesterdayResponse) Get() *ListUsageRecordYesterdayResponse {
	return v.value
}

func (v *NullableListUsageRecordYesterdayResponse) Set(val *ListUsageRecordYesterdayResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListUsageRecordYesterdayResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListUsageRecordYesterdayResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListUsageRecordYesterdayResponse(val *ListUsageRecordYesterdayResponse) *NullableListUsageRecordYesterdayResponse {
	return &NullableListUsageRecordYesterdayResponse{value: val, isSet: true}
}

func (v NullableListUsageRecordYesterdayResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListUsageRecordYesterdayResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
