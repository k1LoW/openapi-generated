...
func NewListSipAuthCallsCredentialListMappingResponse() *ListSipAuthCallsCredentialListMappingResponse {
	this := ListSipAuthCallsCredentialListMappingResponse{}
	return &this
}
...
func (o *ListSipAuthCallsCredentialListMappingResponse) GetContents() []ApiV2010AccountSipSipDomainSipAuthSipAuthCallsSipAuthCallsCredentialListMapping {
	if o == nil || o.Contents == nil {
		var ret []ApiV2010AccountSipSipDomainSipAuthSipAuthCallsSipAuthCallsCredentialListMapping
		return ret
	}
	return o.Contents
}
...
// SetContents gets a reference to the given []ApiV2010AccountSipSipDomainSipAuthSipAuthCallsSipAuthCallsCredentialListMapping and assigns it to the Contents field.
...
func (o ListSipAuthCallsCredentialListMappingResponse) MarshalJSON() ([]byte, error) {
...
type NullableListSipAuthCallsCredentialListMappingResponse struct {
	value *ListSipAuthCallsCredentialListMappingResponse
	isSet bool
}

func (v NullableListSipAuthCallsCredentialListMappingResponse) Get() *ListSipAuthCallsCredentialListMappingResponse {
	return v.value
}

func (v *NullableListSipAuthCallsCredentialListMappingResponse) Set(val *ListSipAuthCallsCredentialListMappingResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListSipAuthCallsCredentialListMappingResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListSipAuthCallsCredentialListMappingResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListSipAuthCallsCredentialListMappingResponse(val *ListSipAuthCallsCredentialListMappingResponse) *NullableListSipAuthCallsCredentialListMappingResponse {
	return &NullableListSipAuthCallsCredentialListMappingResponse{value: val, isSet: true}
}

func (v NullableListSipAuthCallsCredentialListMappingResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListSipAuthCallsCredentialListMappingResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
