...
func NewApiV2010AccountTranscription() *ApiV2010AccountTranscription {
	this := ApiV2010AccountTranscription{}
	return &this
}
...
func (o *ApiV2010AccountTranscription) SetAccountSidNil() {
...
func (o *ApiV2010AccountTranscription) SetApiVersionNil() {
...
func (o *ApiV2010AccountTranscription) SetDateCreatedNil() {
...
func (o *ApiV2010AccountTranscription) SetDateUpdatedNil() {
...
func (o *ApiV2010AccountTranscription) SetDurationNil() {
	o.Duration.Set(nil)
}
...
func (o *ApiV2010AccountTranscription) SetPriceNil() {
	o.Price.Set(nil)
}
...
func (o *ApiV2010AccountTranscription) SetPriceUnitNil() {
	o.PriceUnit.Set(nil)
}
...
func (o *ApiV2010AccountTranscription) SetRecordingSidNil() {
...
func (o *ApiV2010AccountTranscription) SetSidNil() {
	o.Sid.Set(nil)
}
...
func (o *ApiV2010AccountTranscription) SetStatusNil() {
	o.Status.Set(nil)
}
...
func (o *ApiV2010AccountTranscription) SetTranscriptionTextNil() {
...
func (o *ApiV2010AccountTranscription) SetTypeNil() {
	o.Type.Set(nil)
}
...
func (o *ApiV2010AccountTranscription) SetUriNil() {
	o.Uri.Set(nil)
}
...
func (o ApiV2010AccountTranscription) MarshalJSON() ([]byte, error) {
...
type NullableApiV2010AccountTranscription struct {
	value *ApiV2010AccountTranscription
	isSet bool
}

func (v NullableApiV2010AccountTranscription) Get() *ApiV2010AccountTranscription {
	return v.value
}

func (v *NullableApiV2010AccountTranscription) Set(val *ApiV2010AccountTranscription) {
	v.value = val
	v.isSet = true
}

func (v NullableApiV2010AccountTranscription) IsSet() bool {
	return v.isSet
}

func (v *NullableApiV2010AccountTranscription) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiV2010AccountTranscription(val *ApiV2010AccountTranscription) *NullableApiV2010AccountTranscription {
	return &NullableApiV2010AccountTranscription{value: val, isSet: true}
}

func (v NullableApiV2010AccountTranscription) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiV2010AccountTranscription) UnmarshalJSON(src []byte) error {
	v.isSet = true
