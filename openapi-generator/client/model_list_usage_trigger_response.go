...
// GetUsageTriggers returns the UsageTriggers field value if set, zero value otherwise.
func (o *ListUsageTriggerResponse) GetUsageTriggers() []ApiV2010AccountUsageUsageTrigger {
	if o == nil || o.UsageTriggers == nil {
		var ret []ApiV2010AccountUsageUsageTrigger
		return ret
	}
	return o.UsageTriggers
}

// GetUsageTriggersOk returns a tuple with the UsageTriggers field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ListUsageTriggerResponse) GetUsageTriggersOk() ([]ApiV2010AccountUsageUsageTrigger, bool) {
	if o == nil || o.UsageTriggers == nil {
		return nil, false
	}
	return o.UsageTriggers, true
}
...
// SetUsageTriggers gets a reference to the given []ApiV2010AccountUsageUsageTrigger and assigns it to the UsageTriggers field.
func (o *ListUsageTriggerResponse) SetUsageTriggers(v []ApiV2010AccountUsageUsageTrigger) {
	o.UsageTriggers = v
}

func (o ListUsageTriggerResponse) MarshalJSON() ([]byte, error) {
	...
	if o.UsageTriggers != nil {
		toSerialize["usage_triggers"] = o.UsageTriggers
	}
	return json.Marshal(toSerialize)
}

type NullableListUsageTriggerResponse struct {
	value *ListUsageTriggerResponse
	isSet bool
}

func (v NullableListUsageTriggerResponse) Get() *ListUsageTriggerResponse {
	return v.value
}

func (v *NullableListUsageTriggerResponse) Set(val *ListUsageTriggerResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListUsageTriggerResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListUsageTriggerResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListUsageTriggerResponse(val *ListUsageTriggerResponse) *NullableListUsageTriggerResponse {
	return &NullableListUsageTriggerResponse{value: val, isSet: true}
}

func (v NullableListUsageTriggerResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListUsageTriggerResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
