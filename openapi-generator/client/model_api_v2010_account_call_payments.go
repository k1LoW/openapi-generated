...
func NewApiV2010AccountCallPayments() *ApiV2010AccountCallPayments {
	this := ApiV2010AccountCallPayments{}
	return &this
}
...
func (o *ApiV2010AccountCallPayments) SetAccountSidNil() {
...
func (o *ApiV2010AccountCallPayments) SetCallSidNil() {
	o.CallSid.Set(nil)
}
...
func (o *ApiV2010AccountCallPayments) SetDateCreatedNil() {
...
func (o *ApiV2010AccountCallPayments) SetDateUpdatedNil() {
...
func (o *ApiV2010AccountCallPayments) SetSidNil() {
	o.Sid.Set(nil)
}
...
func (o *ApiV2010AccountCallPayments) SetUriNil() {
	o.Uri.Set(nil)
}
...
func (o ApiV2010AccountCallPayments) MarshalJSON() ([]byte, error) {
...
type NullableApiV2010AccountCallPayments struct {
	value *ApiV2010AccountCallPayments
	isSet bool
}

func (v NullableApiV2010AccountCallPayments) Get() *ApiV2010AccountCallPayments {
	return v.value
}

func (v *NullableApiV2010AccountCallPayments) Set(val *ApiV2010AccountCallPayments) {
	v.value = val
	v.isSet = true
}

func (v NullableApiV2010AccountCallPayments) IsSet() bool {
	return v.isSet
}

func (v *NullableApiV2010AccountCallPayments) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiV2010AccountCallPayments(val *ApiV2010AccountCallPayments) *NullableApiV2010AccountCallPayments {
	return &NullableApiV2010AccountCallPayments{value: val, isSet: true}
}

func (v NullableApiV2010AccountCallPayments) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiV2010AccountCallPayments) UnmarshalJSON(src []byte) error {
	v.isSet = true
