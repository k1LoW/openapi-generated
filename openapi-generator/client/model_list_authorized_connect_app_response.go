...
func NewListAuthorizedConnectAppResponse() *ListAuthorizedConnectAppResponse {
	this := ListAuthorizedConnectAppResponse{}
	return &this
}
...
// GetAuthorizedConnectApps returns the AuthorizedConnectApps field value if set, zero value otherwise.
func (o *ListAuthorizedConnectAppResponse) GetAuthorizedConnectApps() []ApiV2010AccountAuthorizedConnectApp {
	if o == nil || o.AuthorizedConnectApps == nil {
		var ret []ApiV2010AccountAuthorizedConnectApp
		return ret
	}
	return o.AuthorizedConnectApps
}

// GetAuthorizedConnectAppsOk returns a tuple with the AuthorizedConnectApps field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ListAuthorizedConnectAppResponse) GetAuthorizedConnectAppsOk() ([]ApiV2010AccountAuthorizedConnectApp, bool) {
	if o == nil || o.AuthorizedConnectApps == nil {
		return nil, false
	}
	return o.AuthorizedConnectApps, true
}
...
// SetAuthorizedConnectApps gets a reference to the given []ApiV2010AccountAuthorizedConnectApp and assigns it to the AuthorizedConnectApps field.
func (o *ListAuthorizedConnectAppResponse) SetAuthorizedConnectApps(v []ApiV2010AccountAuthorizedConnectApp) {
	o.AuthorizedConnectApps = v
}
...
func (o ListAuthorizedConnectAppResponse) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if o.AuthorizedConnectApps != nil {
		toSerialize["authorized_connect_apps"] = o.AuthorizedConnectApps
	}
	if o.End != nil {
...
type NullableListAuthorizedConnectAppResponse struct {
	value *ListAuthorizedConnectAppResponse
	isSet bool
}

func (v NullableListAuthorizedConnectAppResponse) Get() *ListAuthorizedConnectAppResponse {
	return v.value
}

func (v *NullableListAuthorizedConnectAppResponse) Set(val *ListAuthorizedConnectAppResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListAuthorizedConnectAppResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListAuthorizedConnectAppResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListAuthorizedConnectAppResponse(val *ListAuthorizedConnectAppResponse) *NullableListAuthorizedConnectAppResponse {
	return &NullableListAuthorizedConnectAppResponse{value: val, isSet: true}
}

func (v NullableListAuthorizedConnectAppResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListAuthorizedConnectAppResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
