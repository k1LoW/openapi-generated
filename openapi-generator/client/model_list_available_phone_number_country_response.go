...
func NewListAvailablePhoneNumberCountryResponse() *ListAvailablePhoneNumberCountryResponse {
	this := ListAvailablePhoneNumberCountryResponse{}
	return &this
}
...
func (o *ListAvailablePhoneNumberCountryResponse) GetCountries() []ApiV2010AccountAvailablePhoneNumberCountry {
	if o == nil || o.Countries == nil {
		var ret []ApiV2010AccountAvailablePhoneNumberCountry
		return ret
	}
	return o.Countries
}
...
// SetCountries gets a reference to the given []ApiV2010AccountAvailablePhoneNumberCountry and assigns it to the Countries field.
...
func (o ListAvailablePhoneNumberCountryResponse) MarshalJSON() ([]byte, error) {
...
type NullableListAvailablePhoneNumberCountryResponse struct {
	value *ListAvailablePhoneNumberCountryResponse
	isSet bool
}

func (v NullableListAvailablePhoneNumberCountryResponse) Get() *ListAvailablePhoneNumberCountryResponse {
	return v.value
}

func (v *NullableListAvailablePhoneNumberCountryResponse) Set(val *ListAvailablePhoneNumberCountryResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListAvailablePhoneNumberCountryResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListAvailablePhoneNumberCountryResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListAvailablePhoneNumberCountryResponse(val *ListAvailablePhoneNumberCountryResponse) *NullableListAvailablePhoneNumberCountryResponse {
	return &NullableListAvailablePhoneNumberCountryResponse{value: val, isSet: true}
}

func (v NullableListAvailablePhoneNumberCountryResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListAvailablePhoneNumberCountryResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
