...
func (o *ListParticipantResponse) GetParticipants() []ApiV2010AccountConferenceParticipant {
	if o == nil || o.Participants == nil {
		var ret []ApiV2010AccountConferenceParticipant
		return ret
	}
...
// SetParticipants gets a reference to the given []ApiV2010AccountConferenceParticipant and assigns it to the Participants field.
...
func (o ListParticipantResponse) MarshalJSON() ([]byte, error) {
...
type NullableListParticipantResponse struct {
	value *ListParticipantResponse
	isSet bool
}

func (v NullableListParticipantResponse) Get() *ListParticipantResponse {
	return v.value
}

func (v *NullableListParticipantResponse) Set(val *ListParticipantResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListParticipantResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListParticipantResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListParticipantResponse(val *ListParticipantResponse) *NullableListParticipantResponse {
	return &NullableListParticipantResponse{value: val, isSet: true}
}

func (v NullableListParticipantResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListParticipantResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
