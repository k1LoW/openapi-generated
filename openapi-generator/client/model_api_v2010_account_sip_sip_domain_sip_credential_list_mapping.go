...
func NewApiV2010AccountSipSipDomainSipCredentialListMapping() *ApiV2010AccountSipSipDomainSipCredentialListMapping {
	this := ApiV2010AccountSipSipDomainSipCredentialListMapping{}
	return &this
}
...
func (o *ApiV2010AccountSipSipDomainSipCredentialListMapping) SetAccountSidNil() {
...
func (o *ApiV2010AccountSipSipDomainSipCredentialListMapping) SetDateCreatedNil() {
...
func (o *ApiV2010AccountSipSipDomainSipCredentialListMapping) SetDateUpdatedNil() {
...
func (o *ApiV2010AccountSipSipDomainSipCredentialListMapping) SetDomainSidNil() {
	o.DomainSid.Set(nil)
}
...
func (o *ApiV2010AccountSipSipDomainSipCredentialListMapping) SetFriendlyNameNil() {
...
func (o *ApiV2010AccountSipSipDomainSipCredentialListMapping) SetSidNil() {
	o.Sid.Set(nil)
}
...
func (o *ApiV2010AccountSipSipDomainSipCredentialListMapping) SetUriNil() {
	o.Uri.Set(nil)
}
...
func (o ApiV2010AccountSipSipDomainSipCredentialListMapping) MarshalJSON() ([]byte, error) {
...
type NullableApiV2010AccountSipSipDomainSipCredentialListMapping struct {
	value *ApiV2010AccountSipSipDomainSipCredentialListMapping
	isSet bool
}

func (v NullableApiV2010AccountSipSipDomainSipCredentialListMapping) Get() *ApiV2010AccountSipSipDomainSipCredentialListMapping {
	return v.value
}

func (v *NullableApiV2010AccountSipSipDomainSipCredentialListMapping) Set(val *ApiV2010AccountSipSipDomainSipCredentialListMapping) {
	v.value = val
	v.isSet = true
}

func (v NullableApiV2010AccountSipSipDomainSipCredentialListMapping) IsSet() bool {
	return v.isSet
}

func (v *NullableApiV2010AccountSipSipDomainSipCredentialListMapping) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiV2010AccountSipSipDomainSipCredentialListMapping(val *ApiV2010AccountSipSipDomainSipCredentialListMapping) *NullableApiV2010AccountSipSipDomainSipCredentialListMapping {
	return &NullableApiV2010AccountSipSipDomainSipCredentialListMapping{value: val, isSet: true}
}

func (v NullableApiV2010AccountSipSipDomainSipCredentialListMapping) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiV2010AccountSipSipDomainSipCredentialListMapping) UnmarshalJSON(src []byte) error {
	v.isSet = true
