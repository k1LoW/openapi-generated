...
func NewApiV2010AccountSipSipCredentialList() *ApiV2010AccountSipSipCredentialList {
	this := ApiV2010AccountSipSipCredentialList{}
	return &this
}
...
func (o *ApiV2010AccountSipSipCredentialList) SetAccountSidNil() {
...
func (o *ApiV2010AccountSipSipCredentialList) SetDateCreatedNil() {
...
func (o *ApiV2010AccountSipSipCredentialList) SetDateUpdatedNil() {
...
func (o *ApiV2010AccountSipSipCredentialList) SetFriendlyNameNil() {
...
func (o *ApiV2010AccountSipSipCredentialList) SetSidNil() {
	o.Sid.Set(nil)
}
...
func (o *ApiV2010AccountSipSipCredentialList) SetUriNil() {
	o.Uri.Set(nil)
}
...
func (o ApiV2010AccountSipSipCredentialList) MarshalJSON() ([]byte, error) {
...
type NullableApiV2010AccountSipSipCredentialList struct {
	value *ApiV2010AccountSipSipCredentialList
	isSet bool
}

func (v NullableApiV2010AccountSipSipCredentialList) Get() *ApiV2010AccountSipSipCredentialList {
	return v.value
}

func (v *NullableApiV2010AccountSipSipCredentialList) Set(val *ApiV2010AccountSipSipCredentialList) {
	v.value = val
	v.isSet = true
}

func (v NullableApiV2010AccountSipSipCredentialList) IsSet() bool {
	return v.isSet
}

func (v *NullableApiV2010AccountSipSipCredentialList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiV2010AccountSipSipCredentialList(val *ApiV2010AccountSipSipCredentialList) *NullableApiV2010AccountSipSipCredentialList {
	return &NullableApiV2010AccountSipSipCredentialList{value: val, isSet: true}
}

func (v NullableApiV2010AccountSipSipCredentialList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiV2010AccountSipSipCredentialList) UnmarshalJSON(src []byte) error {
	v.isSet = true
