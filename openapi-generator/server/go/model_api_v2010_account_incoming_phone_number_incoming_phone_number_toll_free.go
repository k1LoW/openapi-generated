...
// AssertApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberTollFreeRequired checks if the required fields are not zero-ed
func AssertApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberTollFreeRequired(obj ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberTollFree) error {
	if obj.Capabilities != nil {
		if err := AssertApiV2010AccountIncomingPhoneNumberCapabilitiesRequired(*obj.Capabilities); err != nil {
			return err
		}
	}
	return nil
...
// AssertRecurseApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberTollFreeRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberTollFree (e.g. [][]ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberTollFree), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberTollFreeRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberTollFree, ok := obj.(ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberTollFree)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberTollFreeRequired(aApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberTollFree)
	})
}
