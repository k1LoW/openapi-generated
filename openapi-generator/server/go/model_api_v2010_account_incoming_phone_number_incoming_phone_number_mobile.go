...
// AssertApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberMobileRequired checks if the required fields are not zero-ed
func AssertApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberMobileRequired(obj ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberMobile) error {
...
// AssertRecurseApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberMobileRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberMobile (e.g. [][]ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberMobile), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberMobileRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberMobile, ok := obj.(ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberMobile)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberMobileRequired(aApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberMobile)
	})
}
