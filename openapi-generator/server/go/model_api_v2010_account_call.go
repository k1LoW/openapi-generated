...
// AssertApiV2010AccountCallRequired checks if the required fields are not zero-ed
func AssertApiV2010AccountCallRequired(obj ApiV2010AccountCall) error {
	return nil
}

// AssertRecurseApiV2010AccountCallRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of ApiV2010AccountCall (e.g. [][]ApiV2010AccountCall), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseApiV2010AccountCallRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aApiV2010AccountCall, ok := obj.(ApiV2010AccountCall)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertApiV2010AccountCallRequired(aApiV2010AccountCall)
	})
}
