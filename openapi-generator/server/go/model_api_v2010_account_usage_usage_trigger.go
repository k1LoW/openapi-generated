...
// AssertApiV2010AccountUsageUsageTriggerRequired checks if the required fields are not zero-ed
func AssertApiV2010AccountUsageUsageTriggerRequired(obj ApiV2010AccountUsageUsageTrigger) error {
	return nil
}

// AssertRecurseApiV2010AccountUsageUsageTriggerRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of ApiV2010AccountUsageUsageTrigger (e.g. [][]ApiV2010AccountUsageUsageTrigger), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseApiV2010AccountUsageUsageTriggerRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aApiV2010AccountUsageUsageTrigger, ok := obj.(ApiV2010AccountUsageUsageTrigger)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertApiV2010AccountUsageUsageTriggerRequired(aApiV2010AccountUsageUsageTrigger)
	})
}
