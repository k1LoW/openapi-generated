...
// AssertApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberLocalRequired checks if the required fields are not zero-ed
func AssertApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberLocalRequired(obj ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberLocal) error {
...
// AssertRecurseApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberLocalRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberLocal (e.g. [][]ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberLocal), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberLocalRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberLocal, ok := obj.(ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberLocal)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberLocalRequired(aApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberLocal)
	})
}
